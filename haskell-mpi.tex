...
\end{enumerate}
Listing~\ref{ThreadedTrap} shows that it is quite easy to use threads to
...
\end{Verbatim}
\caption{Multi-threaded parallel program for calculating definite integrals using the trapzoid method. \label{ThreadedTrap}}
\end{listing}
