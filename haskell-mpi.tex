...
starting at $a$ and ending at $b$ (Figure \ref{trapezoidfig}). A single trapezoid with leftmost $x$
coordinate $x_1$ and horizontal width $h$ has area $h/2(f(x_1) + f(x_1 + h))$.
