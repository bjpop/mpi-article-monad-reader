...
\verb|cabal install haskell-mpi|. Otherwise, paths to MPI include
...
If you are building package with MPI implementation other thatn
...
run is accessible on all machines at the same location\footnote{If you
machines have more than one network interface, create
\verb|~/.openmpi/mca-params.conf| and add to it lines
\verb|btl_tcp_if_include=eth0| and \verb|oob_tcp_include=eth0|,
changing network interface name appropriately}. This should be enough to get you going.
